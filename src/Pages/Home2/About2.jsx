...
const About2 = () => {
    return (
        <div className="max-w-[1320px] mx-auto px-3 2xl:px-0 grid lg:grid-cols-3 items-start gap-6 gap-y-24">
            ...
            <div className="lg:col-span-2 lg:w-[780px] lg:h-[148px] rounded-[10px] bg-[#F3F8F6] grid grid-cols-2 lg:py-0 py-5 lg:grid-cols-4 justify-between items-center">
