...
const InTouch = () => {
    return (
        <div className="lg:mx-0 mx-3">
            <div className="max-w-[1320px] mx-auto lg:px-3 2xl:px-0  bg-[#2CA784] w-full rounded-xl lg:h-[430px]">
                <div className="bg-[url(https://i.imgur.com/JgmI7oz.png)] bg-cover bg-left lg:bg-top rounded-xl h-full p-8 lg:p-24">
