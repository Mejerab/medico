...
const Stats = () => {
    return (
        <div className="max-w-[1320px] mx-auto px-3 2xl:px-0 flex lg:flex-row flex-col justify-between">
            ...
            <div data-aos='fade-left' className="grid lg:grid-cols-2 justify-between gap-7">
                <div className="w-full lg:w-[278px] h-[273px] border p-6 border-[#E1EBE8] space-y-4 rounded-[10px]">
