    ...
    return (
        ...
        >
            ...
            <div className="max-w-[1320px] mx-auto px-3 2xl:px-0 relative z-100">
                <div className="absolute top-64 right-3 2xl:right-0 flex flex-col items-center gap-y-2 z-100">
                    <div className="bg-[#FFFFFF2E] h-[60px] w-[1px]"></div>
                ...
                <Navbar2 />
                <div data-aos='fade-up' className='flex flex-col justify-center gap-y-5 items-center text-white pt-40'>
                    <p className="flex">Average rating 4.9/5 <span className="flex items-center gap-x-0 text-[#E59E05] mx-1 -mt-0.5"><MdOutlineStar /><MdOutlineStar /><MdOutlineStar /><MdOutlineStar /><MdOutlineStarHalf /></span> See our 250 + trusted reviews on Google</p>
                    <h3 className="font-semibold text-center leading-[108%] text-[76px]">Embracing <span className="text-[#2CA784]">Your Wellness</span> <br /> Together Daily with Us.</h3>
                    <p className="w-6/12 text-center leading-[180%]">Logistics ensures the efficient movement of goods, managing transportation, storage, and delivery. It plays a vital role in connecting businesses.</p>
                ...
                <div className="max-w-[1320px] mx-auto mt-32 px-3 2xl:px-0">
